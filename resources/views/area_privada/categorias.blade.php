    ...
    <section id="widget-grid" class="">
        <div class="row" class="col-xs-12 col-md-12  col-sm-12 col-lg-12">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-1" data-widget-editbutton="false"
                    ...
                    <div class="row">
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form id="nueva-categoria" class="smart-form col-xs-12 col-md-12 col-sm-12"
                                            ...
                                            <div class="row">
                                                <section class="col col-xs-12 col-md-12 col-sm-12">
                                                    ...
                                                    <label for="address2" class="input">
                                                        <input type="text" name="descripcion" id="Direccion"
                ...
                <!--<div class="well well-sm well-light">-->
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-" data-widget-editbutton="false"
                     data-widget-custombutton="false" role="widget" style="">
                    ...
                    <div class="row">
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form id="nueva-subcategoria" class="smart-form col-xs-12 col-md-12 col-sm-12"
                                  novalidate="novalidate">
                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-" data-widget-editbutton="false"
                    ...
                    <div class="row">
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form id="eliminar-categoria" class="smart-form col-xs-12 col-md-12 col-sm-12"
                                  novalidate="novalidate">
                                <div class="row" style="margin:0">
                                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                ...
                                <footer>
                                    <button  type="submit" class="btn btn-danger">
                                        <i class="fa fa-trash-o"></i> Eliminar categoria
                                    </button>
                                </footer>
                            </form>
                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-" data-widget-editbutton="false"
                    ...
                    <div class="row">
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form id="eliminar-subcategoria" class="smart-form col-xs-12 col-md-12 col-sm-12"
                                  novalidate="novalidate">
                                <div class="row" style="margin:0">
                                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                ...
                                <footer>
                                    <button  type="submit" class="btn btn-danger">
                                        <i class="fa fa-trash-o"></i> Eliminar subcategoria
                                    </button>
                                </footer>
                            </form>
